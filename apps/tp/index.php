...
<head>
    ...
    <link rel="stylesheet" href="<?=DOCUMENT_STATIC.DS?>css/bootstrap.min.3.css">
    <link rel="stylesheet" href="<?=DOCUMENT_STATIC.DS?>css/templatemo_main.css">
</head>
<body>
<div id="main-wrapper">
    <!--[if lt IE 7]>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 affix text-center" style="z-index: 1;">
        <h1 class="templatemo-site-title">
            <a href="#">NATURE</a>
            <img src="<?=DOCUMENT_STATIC.DS?>images/btn-menu.png" alt="main menu" id="m-btn" class="pull-right visible-xs visible-sm" >
        </h1>
    ...
    <div class="image-section">
        <div class="image-container">
            <img src="<?=DOCUMENT_STATIC.DS?>images/nature1.jpg" id="home-img" class="main-img inactive" alt="Home">
            <img src="<?=DOCUMENT_STATIC.DS?>images/nature2.jpg" id="about-img" class="inactive" alt="About">
            <img src="<?=DOCUMENT_STATIC.DS?>images/nature3.jpg" id="services-img"  class="inactive" alt="Services">
            <img src="<?=DOCUMENT_STATIC.DS?>images/nature4.jpg" id="testimonial-img" class="inactive" alt="Testimonial">
            <img src="<?=DOCUMENT_STATIC.DS?>images/nature5.jpg" id="contact-img" class="inactive" alt="Contact">
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 footer">
            <p class="footer-text">
                <span>Copyright &copy; <?=date("Y",time())?> Company Name - Design: TemplateMo</span>
            </p>
        </div><!-- /.footer -->
    </div>
...
<script src="<?=DOCUMENT_STATIC.DS?>js/jquery.min.js"></script>
<script src="<?=DOCUMENT_STATIC.DS?>js/jquery.backstretch.min.js"></script>
<script src="<?=DOCUMENT_STATIC.DS?>js/templatemo_script.js"></script>
